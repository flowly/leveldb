...
SHARED_MAJOR = $(shell grep  -o -P "kMajorVersion = (\d+)" include/leveldb/db.h|grep -o -P "\d+")
SHARED_MINOR = $(shell grep  -o -P "kMinorVersion = (\d+)" include/leveldb/db.h|grep -o -P "\d+")
SHARED1 = libleveldb.$(PLATFORM_SHARED_EXT)
